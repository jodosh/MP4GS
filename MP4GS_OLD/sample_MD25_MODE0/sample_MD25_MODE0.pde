...
/*  mv_right(400, SLOW);
  ...
  while (obj_reached == 0) {
    ...
    Serial.print(enc1_before, DEC);
    Serial.print("            ");
    Serial.println(enc2_before, DEC);
  }    
  delay(500);
  Serial.print("enc1_after: ");
  Serial.print(enc1_after, DEC);
  Serial.println();
  Serial.print("enc2_after: ");
  Serial.print(enc2_after, DEC);
  Serial.println();*/
//  digitalWrite(ledPin,LOW);
}
